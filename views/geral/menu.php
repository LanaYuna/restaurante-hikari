...
<main class="w-full p-24">
        ...
        <section class="mb-12">
            ...
            <?php else: ?>
                ...
                <?php foreach ($produtosDaCategoria as $produto): ?>
                    ...
                    <div
                        class="abrirCardProduto bg-zinc-900 border flex-col border-zinc-800 p-4 rounded-xl hover:border-zinc-700 relative group cursor-pointer transition-all"
                        data-id="<?php echo $produto['id']; ?>"
                        data-nome="<?php echo $produto['nome']; ?>"
                        data-descricao="<?php echo $produto['descricao']; ?>"
                        data-preco="<?php echo $produto['preco']; ?>"
                    ...
                    >
                        ...
                        <?php if(isset($_SESSION['usuario_tipo']) && $_SESSION['usuario_tipo'] == 'admin'): ?>
                            <div class="border-t border-zinc-800 pt-2 w-full mt-2">
                                <?php include "../admin/produto/gerenciarProduto.php"; ?>
                            </div>
                        <?php endif; ?>
                    ...
                    <?php if(isset($_SESSION['usuario_tipo']) && $_SESSION['usuario_tipo'] == 'admin'): ?>
                        <?php include "../admin/produto/modalEdicaoProduto.php"; ?>
                    <?php endif; ?>
    ...
    <section 
        id="localizacao"
        class="mt-24 max-w-6xl mx-auto bg-zinc-900 border border-zinc-800 p-8 rounded-2xl shadow-2xl flex flex-col md:flex-row gap-8"
    >  
        <div class="flex-1 flex flex-col gap-6">
            ...
            <div class="flex items-center justify-start gap-4 pt-4 border-t border-zinc-800/60 mt-auto">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="https://wa.me/554491152614?text=Olá!%20Gostaria%20de%20fazer%20um%20pedido." 
                        target="_blank" 
                        rel="noopener noreferrer" 
